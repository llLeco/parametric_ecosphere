...
# Run the flow using CLI command
run_flow_cli() {
    print_header "Running Parametric Insurance Flow"
    
    print_status "Executing complete parametric insurance flow using CLI..."
...
main() {
    ...
    print_header "Parametric Insurance Flow Runner (CLI Version)"
