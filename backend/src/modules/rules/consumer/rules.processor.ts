...
import { RulesModelService } from '../model/rules.model.service';
import { SmartNodeCommonService } from '../../smartnode-common.service';

// Load validator JSON lazily when needed
// eslint-disable-next-line @typescript-eslint/no-var-requires
const rulesValidator = require('../../config/validators/rules.topic.validator.json');
...
export class RulesProcessor {
  ...
  async handleCreateRule(job: Job) {
    ...
    const addVal = (this.smartNode as any).createValidator
