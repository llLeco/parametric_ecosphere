...
import * as policyRegistryValidator from './policyRegistry.topic.validator.json';
import * as rulesValidator from './rules.topic.validator.json';
import * as triggersValidator from './triggers.topic.validator.json';
